...
export const MATERIALS: MaterialProps[] = [
  ...
  { name: 'Concrete (25 MPa)', E: 25_000, fy: 25, density: 2400, isConcrete: true, fck: 25 },
  { name: 'Concrete (30 MPa)', E: 28_000, fy: 30, density: 2400, isConcrete: true, fck: 30 },
  { name: 'Concrete (35 MPa)', E: 30_000, fy: 35, density: 2400, isConcrete: true, fck: 35 },
  { name: 'Concrete (40 MPa)', E: 31_500, fy: 40, density: 2400, isConcrete: true, fck: 40 },
  { name: 'Concrete (50 MPa)', E: 34_000, fy: 50, density: 2400, isConcrete: true, fck: 50 },
